...
## SYNOPSIS
Finds a Snipe IT consumable.

## SYNTAX

```
Find-SnipeConsumable [[-SearchString] <String>] [-SortOrder <SearchOrder>] [-SortColumn <String>]
...
### Example 1
```powershell
PS C:\> Find-Consumable
```

Finds all consumables.

### Example 2
```powershell
PS C:\> Find-Consumable "Frying Oil"
```

Finds consumables that match the search string "Frying Oil".
