...
### Example 1
```powershell
PS C:\> Find-Department
```

Finds all department.

### Example 2
```powershell
PS C:\> Find-Department "Potato Peeling"
```

Finds departments that match the search string "Potato Peeling".
