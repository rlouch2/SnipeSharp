...
## SYNOPSIS
Finds a Snipe IT category.

## SYNTAX

```
Find-SnipeCategory [[-SearchString] <String>] [-SortOrder <SearchOrder>] [-SortColumn <String>] [-NoEnumerate]
...
### Example 2
```powershell
PS C:\> Find-Category "Peeler"
```

Finds categories that match the search string "Peeler".
